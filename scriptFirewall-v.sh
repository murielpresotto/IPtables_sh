...
func_IP_FORWARD(){
  echo -e "\033[34m Habilitando repasse de pacotes entre as placas ********* [OK] \033[m ";
...
func_SYN_COOKIES(){
  echo -e "\033[34m Habilitando cobtrole contra syn cookies ********* [OK] \033[m ";
...
func_IP_SPOOFING_ALL(){
  echo -e "\033[34m Habilitando Protecao contra IP spoofing ********* [OK] \033[m ";

  ip_spoofing_all=`cat /proc/sys/net/ipv4/conf/all/rp_filter`
  if [ $ip_spoofing_all -eq 0 ];
    then 
      echo "1" > /proc/sys/net/ipv4/conf/all/rp_filter
  fi
}

func_IP_SPOOFING_ETH0(){
  echo -e "\033[34m Habilitando Protecao contra IP spoofing ********* [OK] \033[m ";

  ip_spoofing_eth0=`cat /proc/sys/net/ipv4/conf/eth0/rp_filter`
  if [ $ip_spoofing_eth0 -eq 0 ];
    then 
      echo "1" > /proc/sys/net/ipv4/conf/eth0/rp_filter
  fi
}

func_IP_SPOOFING_ETH1(){
  echo -e "\033[34m Habilitando Protecao contra IP spoofing ********* [OK] \033[m ";

  ip_spoofing_eth1=`cat /proc/sys/net/ipv4/conf/eth1/rp_filter`
  if [ $ip_spoofing_eth2 -eq 0 ];
    then 
      echo "1" > /proc/sys/net/ipv4/conf/eth1/rp_filter
  fi
}

func_IP_SPOOFING_ETH2(){
  echo -e "\033[34m Habilitando Protecao contra IP spoofing ********* [OK] \033[m ";

  ip_spoofing_eth2=`cat /proc/sys/net/ipv4/conf/eth2/rp_filter`
  if [ $ip_spoofing_eth02 -eq 0 ];
    then 
